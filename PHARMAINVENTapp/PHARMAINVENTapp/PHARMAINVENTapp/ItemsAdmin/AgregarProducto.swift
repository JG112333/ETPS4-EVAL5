...
struct AgregarProducto: View {
    ...
    var body: some View {
        ...
        .alert(isPresented: $showAlert) {
            Alert(title: Text("Producto Agregado Con Exito"), message: nil, dismissButton: .default(Text("Aceptar")))
        }
    }
}

struct AgregarProducto_Previews: PreviewProvider {
